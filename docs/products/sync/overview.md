# PanBox Sync - 跨网盘同步自动转码系统 概览

PanBox Sync 是一个面向跨网盘同步、文件处理、自动转码和资源保活的自托管系统，适合把已有资源做进一步分发与治理，尽量减少屏蔽、失效和单盘波动带来的影响。
...
如果你的问题已经不是“怎么找到资源”，而是“怎么让资源更稳、更久、更适合长期分发”，通常就需要 Sync。
...
它更适合作为后台任务系统长期运行，把“跨盘分发、自动转码、资源保活”做成稳定能力，而不是偶发性的手工操作工具。
